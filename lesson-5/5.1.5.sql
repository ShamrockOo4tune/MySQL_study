...
-- Dump completed on 2020-09-06 14:33:07

--
-- Домашнее задание к уроку №5. Часть1. Тема: Операторы, фильтрация, сортировка и ограничение.
--

-- Задача 5.1.5 (по желанию) "Из таблицы catalogs извлекаются записи при помощи запроса. SELECT * FROM catalogs WHERE id IN (5,1,2); Отсортируйте записи в порядке, заданном в списке IN"
